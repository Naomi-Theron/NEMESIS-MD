...
const { takeCommand } = require('../start/ridzcmd/commands');
            ...
            try {
                ...
                await Ridzcoder.sendMessage(m.chat, {
                    ...
                    caption: `- 🖼️ *Screenshot Generated*\n\n` +
                            `📸 *URL:* ${url}\n` +
                            `> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${global.botname || 'NEMESIS MD'} 🥀`
                }, { quoted: m });
