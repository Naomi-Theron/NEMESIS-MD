...
module.exports = [
    {
        ...
        operate: async ({ ridzcoder, m, reply, text, prefix }) => {
            ...
            try {
                ...
                await ridzcoder.sendMessage(m.chat, { text: replyMsg }, { quoted: m });
                await ridzcoder.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
    ...
    },   
    {
        ...
        operate: async ({ ridzcoder, m, reply, text, prefix }) => {
            ...
            try {
                ...
                await ridzcoder.sendMessage(m.chat, { text: definitionText }, { quoted: m });
                await ridzcoder.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
    ...
    },
    {
        ...
        operate: async ({ ridzcoder, m, reply }) => {
            ...
            try {
                ...
                await ridzcoder.sendMessage(m.chat, { text: poemText }, { quoted: m });
                await ridzcoder.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
    ...
    },
    {
        ...
        operate: async ({ ridzcoder, m, reply, text, prefix }) => {
            ...
            try {
                ...
                await ridzcoder.sendMessage(m.chat, { text: fruitText }, { quoted: m });
                await ridzcoder.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
    ...
    },
    {
        ...
        operate: async ({ ridzcoder, m, reply, text, prefix }) => {
            ...
            try {
                ...
                await ridzcoder.sendMessage(m.chat, { text: bookText }, { quoted: m });
                await ridzcoder.sendMessage(m.chat, { react: { text: '✅', key: m.key } });
