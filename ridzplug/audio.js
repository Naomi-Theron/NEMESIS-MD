...
module.exports = [
    ...
    {
        command: ['bass'],
        operate: async ({ Ridzcoder, m, reply, prefix, command }) => {
            try {
                ...
                const mediaPath = await Ridzcoder.downloadAndSaveMediaMessage(quoted);
                ...
                exec(`ffmpeg -i ${mediaPath} -af equalizer=f=54:width_type=o:width=2:g=20 ${outputPath}`, (error) => {
                    ...
                    Ridzcoder.sendMessage(m.chat, { audio: audioBuffer, mimetype: 'audio/mpeg' }, { quoted: m });
  ...
  const mime = quoted?.mimetype || "";
    ...
    try {
      ...
      await Ridzcoder.sendMessage(m.chat, { audio: converted.data, mimetype: 'audio/ogg; codecs=opus', ptt: true }, { quoted: m });
