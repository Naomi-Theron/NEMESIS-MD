...
async function veniceAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
...
async function mistralAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
...
async function perplexityAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
...
async function bardAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
...
async function gpt4NanoAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
...
async function RidzAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
...
async function claudeAICommand(Ridzcoder, chatId, query, message) {
    try {
        if (!query) {
            return await Ridzcoder.sendMessage(chatId, {
