...
async function handleAIChatbot(m, Ridzcoder, body, from, isGroup, botNumber, isCmd, prefix) {
    try {
        ...
        const ignoredNumbers = ['255611199851', '243818786249'];
        ...
        await Ridzcoder.sendPresenceUpdate('composing', from);
        ...
        if (isAskingAboutCreator) {
            response = "I was created by Ridz coder, a skilled developer from Uganda with exceptional coding abilities.";
        } else {
            // Try Llama3 API
            try {
        ...
        await Ridzcoder.sendMessage(from, { text: response }, { quoted: m });
        return true;
